...
$subscription_hub=$(az account show -o tsv --query id)
...
terraform init
terraform plan -var "subscriptionid_hub=$subscription_hub" -var "subscriptionid_spoke=$subscription_spoke"

terraform apply -var "subscriptionid_hub=$subscription_hub" -var "subscriptionid_spoke=$subscription_spoke" -auto-approve